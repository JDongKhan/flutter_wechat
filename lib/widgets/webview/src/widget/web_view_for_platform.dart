...
class _WebViewForPlatformState extends State<WebViewForPlatform> {
  ...
  final WebViewProgressController _progressController =
      WebViewProgressController();
  ...
  void initState() {
    ...
    _webViewController.setUserAgent('SmartMedicalApp');
      ...
      NavigationDelegate(
        ...
        onPageFinished: (String url) {
          ...
          _webViewController
              ...
              .then(
            (value) {
              if (widget.title == null && value != null) {
                setState(() {
